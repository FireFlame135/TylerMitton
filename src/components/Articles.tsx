...
//             Exploring my thoughts on personal projects and industry trends through written reflections and analysis.
//           </p>
//         </div>
...
// NEW VERSION BEING TESTED TO DYNAMICALLY LOAD MOST RECENT ARTICLES
...
const Articles = () => {
  ...
  useEffect(() => {
    const fetchLatestPosts = async () => {
      ...
      console.log("Loaded posts (Articles.tsx):", allPosts);
      // Display up to 3 of the most recent posts
