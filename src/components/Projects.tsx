  ...
  const projects = [
    {
      ...
      altText: "Maze Game screenshot - a 3D maze puzzle game built with Three.js featuring smooth navigation controls and responsive design for all devices"
    },
    {
      ...
      altText: "Portfolio Website homepage screenshot - a clean minimalist personal portfolio with responsive navigation, smooth scroll animations, and dark mode support"
    },
    {
      ...
      techStack: ['React', 'TypeScript', 'ElevenLabs', 'Tailwind CSS'],
      altText: "AI Tutor multimodal learning platform screenshot - an AI-powered tutor accepting whiteboard drawings, text, and voice inputs to help students learn effectively"
    },
    {
      ...
      techStack: ['Express', 'Node.js', 'JavaScript', 'PostgreSQL', 'AWS', 'Tableau'],
      altText: "Ella Rises non-profit website screenshot - a full-stack web application with user authentication, event management, and data visualization dashboard"
    },
    {
      ...
      techStack: ['WordPress'],
      altText: "Doctor's Lounge website screenshot - a WordPress-built website created during an on-campus internship with team collaboration and project management"
    }
];
